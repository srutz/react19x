...
export function App() {
  ...
  console.log("render App", { title, deferredTitle })
  return (
    <div className="h-1 grow self-stretch flex flex-col items-center justify-center gap-2">
      ...
      <input placeholder='Type text' value={title} onChange={(e) => setTitle(e.target.value)} />
      <input type="range" min={0} max={10} value={gap} onChange={(e) => setGap(Number.parseInt(e.target.value, 10))} />
